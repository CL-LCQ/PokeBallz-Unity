...
- (void) StartInterstitialAd {
    ...
    if(!IsLoadRequestLaunched) {
        [[ISN_NativeUtility sharedInstance] ISN_NativeLog: @"StartInterstitialAd request"];
...
-(void) LoadInterstitialAd {
    ...
    if(!IsLoadRequestLaunched) {
        [[ISN_NativeUtility sharedInstance] ISN_NativeLog: @"LoadInterstitialAd request"];
...
- (void)interstitialAdDidUnload:(ADInterstitialAd *)interstitialAd {
    [[ISN_NativeUtility sharedInstance] ISN_NativeLog: @"interstitialAdDidUnload"];
...
- (void)interstitialAd:(ADInterstitialAd *)interstitialAd didFailWithError:(NSError *)error {
    [[ISN_NativeUtility sharedInstance] ISN_NativeLog: @"didFailWithError: %@", error.description];
...
- (void)interstitialAdWillLoad:(ADInterstitialAd *)interstitialAd  {
    [[ISN_NativeUtility sharedInstance] ISN_NativeLog: @"interstitialAdWillLoad"];
...
- (void)interstitialAdActionDidFinish:(ADInterstitialAd *)interstitialAd {
    [[ISN_NativeUtility sharedInstance] ISN_NativeLog: @"interstitialAdActionDidFinish"];
    return;
...
-(void) InitBanner:(int)bannerId  {
    ...
    [[ISN_NativeUtility sharedInstance] ISN_NativeLog: @"IsLandscape %i", IsLandscape];
...
-(void)bannerView:(ADBannerView *)banner didFailToReceiveAdWithError:(NSError *)error{
    if(error != nil) {
        [[ISN_NativeUtility sharedInstance] ISN_NativeLog: @"didFailToReceiveAdWithError %@", error.description];
    }
