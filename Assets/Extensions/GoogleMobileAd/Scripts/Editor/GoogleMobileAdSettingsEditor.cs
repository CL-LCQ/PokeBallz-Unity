...
public class GoogleMobileAdSettingsEditor : Editor {
	...
	public static void UpdateVersionInfo() {
		SA.Util.Files.Write(SA_VersionsManager.GMA_VERSION_INFO_PATH, GoogleMobileAdSettings.VERSION_NUMBER);
		UpdateManifest ();
	}
	...
	private void EditorTesting() {
		...
		GoogleMobileAdSettings.Instance.IsEditorTestingEnabled = SA_EditorTool.ToggleFiled("Editor Testing", GoogleMobileAdSettings.Instance.IsEditorTestingEnabled);
	...
	public static void ResetSettings() {
		SA.Util.Files.DeleteFile("Extensions/GoogleMobileAd/Resources/GoogleMobileAdSettings.asset");
