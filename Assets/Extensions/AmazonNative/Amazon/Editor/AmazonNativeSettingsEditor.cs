...
public class AmazonNativeSettingsEditor : Editor {
	...
	private void GeneralOptions() {
		...
		if(AmazonNativeSettings.Instance.ShowActions) {
			...
			if(GUILayout.Button("Remove Amazon Libraries",  GUILayout.Width(200))) {
				SA.Util.Files.DeleteFolder("Plugins/Amazon");
				SA.Util.Files.DeleteFolder("Plugins/AmazonCommon");
				SA.Util.Files.DeleteFolder("Plugins/AmazonGameCirclePlugin");
				SA.Util.Files.DeleteFolder("Plugins/Android/Advertising_Res");
				SA.Util.Files.DeleteFolder("Plugins/Android/assets");
				SA.Util.Files.DeleteFolder("Plugins/Android/Billing_Res");
				SA.Util.Files.DeleteFolder("Plugins/Android/GameCircle_Res");

				SA.Util.Files.DeleteFile("Plugins/AmazonGameCircleLicense.txt");
				SA.Util.Files.DeleteFile("Plugins/AmazonGameCircleNotice.txt");
				SA.Util.Files.DeleteFile("Plugins/AmazonGameCirclePluginVersion.txt");

				SA.Util.Files.DeleteFile("Plugins/Android/libs/armeabi/libAmazonIapV2Bridge.so");
				SA.Util.Files.DeleteFile("Plugins/Android/libs/armeabi/libAmazonMobileAdsBridge.so");

				SA.Util.Files.DeleteFile("Plugins/Android/libs/armeabi-v7a/libAmazonIapV2Bridge.so");
				SA.Util.Files.DeleteFile("Plugins/Android/libs/armeabi-v7a/libAmazonMobileAdsBridge.so");

				SA.Util.Files.DeleteFile("Plugins/Android/libs/x86/libAmazonIapV2Bridge.so");
				SA.Util.Files.DeleteFile("Plugins/Android/libs/x86/libAmazonMobileAdsBridge.so");

				SA.Util.Files.DeleteFile("Plugins/Android/AmazonCptPluginsUtils-1.0.jar");
				SA.Util.Files.DeleteFile("Plugins/Android/AmazonIapV2Client.jar");
				SA.Util.Files.DeleteFile("Plugins/Android/AmazonIapV2JavaService-1.0.jar");
				SA.Util.Files.DeleteFile("Plugins/Android/AmazonInsights-android-sdk.jar");
				SA.Util.Files.DeleteFile("Plugins/Android/AmazonMobileAdsAndroidSDK3P-1.1.jar");
				SA.Util.Files.DeleteFile("Plugins/Android/AmazonMobileAdsClient.jar");
				SA.Util.Files.DeleteFile("Plugins/Android/AmazonMobileAdsJavaService-1.0.jar");
				SA.Util.Files.DeleteFile("Plugins/Android/amazonnative.jar");
				SA.Util.Files.DeleteFile("Plugins/Android/gamecirclesdk.jar");
				SA.Util.Files.DeleteFile("Plugins/Android/gcunity.jar");
				SA.Util.Files.DeleteFile("Plugins/Android/gson-2.2.4.jar");
				SA.Util.Files.DeleteFile("Plugins/Android/in-app-purchasing-2.0.61.jar");
				SA.Util.Files.DeleteFile("Plugins/Android/login-with-amazon-sdk.jar");



				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONAd.h");
				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONAd.m");
				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONAd.m");
				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONAdPair.h");
				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONAdPair.m");
				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONAdPosition.h");
				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONAdPosition.m");
				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONAdShown.m");
				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONAdShown.h");
				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONAmazonMobileAds.h");
				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONAmazonMobileAdsBridge.mm");
				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONAmazonMobileAdsBridge.h");
				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONAmazonMobileAdsImpl.h");

				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONAmazonMobileAdsImpl.m");
				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONAmazonMobileAdsImplStub.m");
				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONAmazonMobileAdsImplStub.h");
				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONAmazonMobileAdsJsonFromObject.m");
				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONAmazonMobileAdsJsonFromObject.h");
				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONAmazonMobileAdsObjectFromJson.h");
				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONAmazonMobileAdsObjectFromJson.m");
				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONAmazonMobileAdsObjectiveCController.h");
				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONAmazonMobileAdsObjectiveCControllerImpl.m");
				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONAmazonMobileAdsObjectiveCControllerImpl.h");
				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONApplicationKey.m");
				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONApplicationKey.h");

				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONEnums.m");
				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONEnums.h");
				SA.Util.Files.DeleteFile("Plugins/IOS/AmazonInsightsSDK.a");
				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONIsEqual.h");
				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONIsEqual.m");
				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONIsReady.h");
				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONIsReady.m");
				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONLoadingStarted.m");
				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONLoadingStarted.h");
				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONPlacement.h");
				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONPlacement.m");
				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONShouldEnable.h");
				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONShouldEnable.m");

				SA.Util.Files.DeleteFile("Plugins/IOS/GameCircle.h");
				SA.Util.Files.DeleteFile("Plugins/IOS/GameCircle.a");
				SA.Util.Files.DeleteFile("Plugins/IOS/libGameCircleUnityProxy.a");
				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONIsEqual.h");
				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONIsEqual.m");
				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONIsReady.h");
				SA.Util.Files.DeleteFile("Plugins/IOS/AMAZONIsReady.m");
				...
				SA.Util.Files.DeleteFolder("Plugins/IOS/GameCircle.bundle");
	...
	public static void UpdatePluginSettings() {
		if(AmazonNativeSettings.Instance.IsGameCircleEnabled) {
			if(!SA.Util.Files.IsFolderExists("Plugins/Android/GameCircle_Res")) {
		...
		if(AmazonNativeSettings.Instance.IsBillingEnabled) {
			if(!SA.Util.Files.IsFolderExists("Plugins/Android/Billing_Res")) {
	...
	public static void UpdateVersionInfo() {
		SA.Util.Files.Write(SA_VersionsManager.AMN_VERSION_INFO_PATH, AmazonNativeSettings.VERSION_NUMBER);
	}
