...
public class IOSNativeSettingsEditor : Editor {
	...
	public static void UpdateVersionInfo() {
		SA.Util.Files.Write(SA_VersionsManager.ISN_VERSION_INFO_PATH, IOSNativeSettings.VERSION_NUMBER);
	}
	...
	public static void UpdatePluginSettings() {
		...
		if(!IOSNativeSettings.Instance.EnablePickerAPI) {
			...
			SA.Util.Files.CopyFile(PluginsInstalationUtil.IOS_SOURCE_PATH + "ISN_FilePicker.mm.txt", 	PluginsInstalationUtil.IOS_DESTANATION_PATH + "ISN_FilePicker.mm");
		}
		...
		if(!IOSNativeSettings.Instance.EnableSoomla) {
			...
			if(SA.Util.Files.IsFileExists("Plugins/IOS/libSoomlaGrowLite.a")) {
				ChnageDefineState(ISN_Soomla_Path, 						"SOOMLA", IOSNativeSettings.Instance.EnableSoomla);
				SA.Util.Files.CopyFile(PluginsInstalationUtil.IOS_SOURCE_PATH + "ISN_Soomla.mm.txt", 	PluginsInstalationUtil.IOS_DESTANATION_PATH + "ISN_Soomla.mm");
			} else {
