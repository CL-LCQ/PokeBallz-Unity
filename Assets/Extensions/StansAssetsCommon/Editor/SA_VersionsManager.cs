...
public static class SA_VersionsManager  {
	...
	public const string AMN_VERSION_INFO_PATH 	= VERSION_INFO_PATH + "AMfN_VersionInfo.txt";
	...
	public static bool Is_AMN_Installed {
		get {
			return SA.Util.Files.IsFileExists(AMN_VERSION_INFO_PATH);
		} 
	}

	public static int AMN_Version {
		get {
			return GetVersionCode(AMN_VERSION_INFO_PATH);
		} 
	}

	public static int AMN_MagorVersion {
		get {
			return GetMagorVersionCode(AMN_VERSION_INFO_PATH);
		} 
	}

	public static string AMN_StringVersionId {
		get {
			return GetStringVersionId(AMN_VERSION_INFO_PATH);
		}
	}
	...
	public static string InstalledPluginsList {
		...
		get {
			...
			if(Is_AMN_Installed) {
				allPluginsInstalled = allPluginsInstalled + " (Amazon Native)" + "\n";
			}
